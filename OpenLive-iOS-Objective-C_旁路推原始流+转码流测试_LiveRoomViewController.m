...
#define PublishWidth 480
#define PublishHeight 800
...
//                                                                                         orientationMode:AgoraVideoOutputOrientationModeAdaptative];
 ...
 initWithSize:self.videoProfile
                                                     frameRate:AgoraVideoFrameRateFps24
 bitrate:AgoraVideoBitrateStandard
...
- (void)rtcEngine:(AgoraRtcEngineKit *_Nonnull)engine didJoinChannel:(NSString *_Nonnull)channel withUid:(NSUInteger)uid elapsed:(NSInteger)elapsed {
    ...
    [self.rtcEngine addPublishStreamUrl:@"rtmp://xxxx/live/123	" transcodingEnabled:NO];
    ...
    self.agoraLiveTranscoding.videoBitrate = 800;
    ...
    self.publishUrl = @"rtmp://xxxx/live/234";
